...
export const skillsDesign: Skill[] = [
  {
    ...
    iconUrl: './icons/skill-icons/typography.png',
  ...
  },
  {
    ...
    unlocks: 'TypeScript',
    iconUrl: './icons/skill-icons/color.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/layouts.png',
  ...
  },
  {
    ...
    unlocks: 'Prototyping',
    iconUrl: './icons/skill-icons/figma.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/photoshop.png',
  ...
  },
  {
    ...
    unlocks: 'SVGs',
    iconUrl: './icons/skill-icons/illustrator.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/svgs.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/blender.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/prototyping.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/creativity.png',
...
export const skillsProgramming: Skill[] = [
  {
    ...
    unlocks: 'Express',
    iconUrl: './icons/skill-icons/node.png',
    position: [columnPositions[2], rowPositions[2]],
    linkPosition: [columnPositions[2], rowPositions[3]],
  },
  {
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/express.png',
    position: [columnPositions[2], rowPositions[3]],
  },
  {
    name: 'JavaScript',
    ...
    iconUrl: './icons/skill-icons/javascript.png',
  },
  {
    name: 'Bootstrap',
    description: 'A library of UI elements for rapid development.',
    iconUrl: './icons/skill-icons/bootstrap.png',
    position: [columnPositions[0], rowPositions[2]],
  },
  {
    name: 'TypeScript',
    ...
    unlocks: 'React',
    iconUrl: './icons/skill-icons/typescript.png',
    position: [columnPositions[1], rowPositions[3]],
  ...
  },
  {
    ...
    unlocks: 'NextJS',
    iconUrl: './icons/skill-icons/react.png',
    position: [columnPositions[1], rowPositions[4]],
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/nextjs.png',
    position: [columnPositions[1], rowPositions[5]],
  },
  {
    name: 'Three.js',
    description: 'Turn your webpage into a web experience!',
    iconUrl: './icons/skill-icons/threejs.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/html.png',
  ...
  },
  {
    ...
    unlocks: 'WordPress',
    iconUrl: './icons/skill-icons/php.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/wordpress.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/godot.png',
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/seo.png',
    position: [columnPositions[2], rowPositions[1]],
  },
  {
    name: 'CSS',
    ...
    unlocks: 'Tailwind',
    iconUrl: './icons/skill-icons/css.png',
    position: [columnPositions[0], rowPositions[0]],
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/tailwind.png',
    position: [columnPositions[0], rowPositions[1]],
  },
]
export const skillsTooling: Skill[] = [
  {
    ...
    unlocks: 'GitHub',
    iconUrl: './icons/skill-icons/git.png',
    position: [columnPositions[1], rowPositions[0]],
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/github.png',
    position: [columnPositions[1], rowPositions[1]],
  },
  {
    name: 'VSCode',
    ...
    unlocks: 'WSL',
    iconUrl: './icons/skill-icons/vscode.png',
    position: [columnPositions[0], rowPositions[0]],
    linkPosition: [columnPositions[0], rowPositions[2]],
  },
  {
    ...
    iconUrl: './icons/skill-icons/chrome.png',
    position: [columnPositions[2], rowPositions[0]],
  ...
  },
  {
    ...
    iconUrl: './icons/skill-icons/lighthouse.png',
    position: [columnPositions[2], rowPositions[2]],
  },
  {
    name: 'Docker',
    description: 'Keep yourself contained, so you are ready to deploy anywhere!',
    iconUrl: './icons/skill-icons/docker.png',
    position: [columnPositions[1], rowPositions[5]],
  },
  {
    name: 'Bash',
    ...
    unlocks: 'ZSH',
    iconUrl: './icons/skill-icons/bash.png',
    position: [columnPositions[1], rowPositions[3]],
    linkPosition: [columnPositions[1], rowPositions[4]],
  },
  {
    ...
    iconUrl: './icons/skill-icons/wsl.png',
    position: [columnPositions[0], rowPositions[2]],
  },
  {
    name: 'ZSH',
